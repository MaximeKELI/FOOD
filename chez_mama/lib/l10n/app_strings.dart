...
const Map<String, Map<AppLang, String>> _strings = {
  ...
  'menu.faq': {AppLang.fr: 'FAQ', AppLang.en: 'FAQ', AppLang.wo: 'FAQ'},
  'menu.addresses': {AppLang.fr: 'Adresses', AppLang.en: 'Addresses', AppLang.wo: 'Adresse yi'},
  'menu.referral': {AppLang.fr: 'Parrainage', AppLang.en: 'Referral', AppLang.wo: 'Parrainage'},
  'menu.disputes': {AppLang.fr: 'Litiges', AppLang.en: 'Disputes', AppLang.wo: 'Litige yi'},
  'menu.driver': {AppLang.fr: 'Mode livreur', AppLang.en: 'Driver mode', AppLang.wo: 'Mode yónnee'},
  'menu.promos': {AppLang.fr: 'Promos vendeur', AppLang.en: 'Seller promos', AppLang.wo: 'Promo jaaykat'},
  'menu.shopSettings': {AppLang.fr: 'Paramètres boutique', AppLang.en: 'Shop settings', AppLang.wo: 'Paramètre bitik'},
  'menu.groupOrder': {AppLang.fr: 'Commande groupée', AppLang.en: 'Group order', AppLang.wo: 'Commande groupe'},
  ...
  'checkout.promo': {AppLang.fr: 'Code promo', AppLang.en: 'Promo code', AppLang.wo: 'Code promo'},
  'checkout.promoHint': {AppLang.fr: 'Entrer un code (optionnel)', AppLang.en: 'Enter code (optional)', AppLang.wo: 'Dugal code (optionnel)'},
  'checkout.fulfillmentSection': {AppLang.fr: 'Livraison ou retrait', AppLang.en: 'Delivery or pickup', AppLang.wo: 'Yónnee walla jël'},
  'checkout.summarySection': {AppLang.fr: 'Récapitulatif', AppLang.en: 'Order summary', AppLang.wo: 'Récapitulatif'},
  ...
  'chat.typing': {
    AppLang.fr: 'En train d’écrire…',
    AppLang.en: 'Typing…',
    AppLang.wo: 'Dafa bind…',
  },
  ...
  'faq.title': {AppLang.fr: 'Aide & FAQ', AppLang.en: 'Help & FAQ', AppLang.wo: 'Ndimbal & FAQ'},
  'faq.empty': {AppLang.fr: 'Aucune question.', AppLang.en: 'No questions yet.', AppLang.wo: 'Amul laaj.'},
  'faq.emptyHint': {AppLang.fr: 'Reviens plus tard.', AppLang.en: 'Check back later.', AppLang.wo: 'Dellul ci kanam.'},
  'addresses.title': {AppLang.fr: 'Mes adresses', AppLang.en: 'My addresses', AppLang.wo: 'Sama adresse'},
  'addresses.add': {AppLang.fr: 'Ajouter', AppLang.en: 'Add', AppLang.wo: 'Yokk'},
  'addresses.edit': {AppLang.fr: 'Modifier', AppLang.en: 'Edit', AppLang.wo: 'Soppi'},
  'addresses.label': {AppLang.fr: 'Libellé', AppLang.en: 'Label', AppLang.wo: 'Tur'},
  'addresses.address': {AppLang.fr: 'Adresse', AppLang.en: 'Address', AppLang.wo: 'Adresse'},
  'addresses.default': {AppLang.fr: 'Adresse par défaut', AppLang.en: 'Default address', AppLang.wo: 'Adresse bu njëkk'},
  'addresses.empty': {AppLang.fr: 'Aucune adresse enregistrée.', AppLang.en: 'No saved addresses.', AppLang.wo: 'Amul adresse.'},
  'addresses.emptyHint': {AppLang.fr: 'Ajoute une adresse pour accélérer le checkout.', AppLang.en: 'Add an address to speed up checkout.', AppLang.wo: 'Yokkal adresse ngir gaw checkout.'},
  'addresses.untitled': {AppLang.fr: 'Sans nom', AppLang.en: 'Untitled', AppLang.wo: 'Amul tur'},
  'referral.title': {AppLang.fr: 'Parrainage', AppLang.en: 'Referral', AppLang.wo: 'Parrainage'},
  'referral.yourCode': {AppLang.fr: 'Ton code', AppLang.en: 'Your code', AppLang.wo: 'Sa code'},
  'referral.reward': {AppLang.fr: 'Récompense : {points} points', AppLang.en: 'Reward: {points} points', AppLang.wo: 'Njariñ : {points} poñ'},
  'referral.copied': {AppLang.fr: 'Code copié', AppLang.en: 'Code copied', AppLang.wo: 'Code kopi na'},
  'referral.redeemTitle': {AppLang.fr: 'Utiliser un code ami', AppLang.en: 'Redeem a friend code', AppLang.wo: 'Jëfandikoo code xarit'},
  'referral.friendCode': {AppLang.fr: 'Code de parrainage', AppLang.en: 'Referral code', AppLang.wo: 'Code parrainage'},
  'referral.friendCodeHint': {AppLang.fr: 'Ex. MAMA2026', AppLang.en: 'e.g. MAMA2026', AppLang.wo: 'Ex. MAMA2026'},
  'referral.redeem': {AppLang.fr: 'Valider', AppLang.en: 'Redeem', AppLang.wo: 'Dëggël'},
  'referral.redeemOk': {AppLang.fr: 'Code validé !', AppLang.en: 'Code redeemed!', AppLang.wo: 'Code dëgg na!'},
  'disputes.title': {AppLang.fr: 'Mes litiges', AppLang.en: 'My disputes', AppLang.wo: 'Sama litige'},
  'disputes.create': {AppLang.fr: 'Ouvrir un litige', AppLang.en: 'Open a dispute', AppLang.wo: 'Ubbi litige'},
  'disputes.open': {AppLang.fr: 'Litige', AppLang.en: 'Dispute', AppLang.wo: 'Litige'},
  'disputes.reason': {AppLang.fr: 'Motif', AppLang.en: 'Reason', AppLang.wo: 'Motif'},
  'disputes.details': {AppLang.fr: 'Détails', AppLang.en: 'Details', AppLang.wo: 'Benn benn'},
  'disputes.orderId': {AppLang.fr: 'N° commande', AppLang.en: 'Order ID', AppLang.wo: 'N° commande'},
  'disputes.orderLine': {AppLang.fr: 'Commande #{id}', AppLang.en: 'Order #{id}', AppLang.wo: 'Commande #{id}'},
  'disputes.empty': {AppLang.fr: 'Aucun litige.', AppLang.en: 'No disputes.', AppLang.wo: 'Amul litige.'},
  'disputes.emptyHint': {AppLang.fr: 'Tu peux ouvrir un litige depuis le détail d’une commande.', AppLang.en: 'Open a dispute from an order detail.', AppLang.wo: 'Mën nga ubbi litige ci détail commande.'},
  'disputes.created': {AppLang.fr: 'Litige créé', AppLang.en: 'Dispute created', AppLang.wo: 'Litige sos na'},
  'driver.title': {AppLang.fr: 'Mode livreur', AppLang.en: 'Driver mode', AppLang.wo: 'Mode yónnee'},
  'driver.goOnline': {AppLang.fr: 'En ligne', AppLang.en: 'Go online', AppLang.wo: 'Ci ligne'},
  'driver.goOffline': {AppLang.fr: 'Hors ligne', AppLang.en: 'Go offline', AppLang.wo: 'Génn ligne'},
  'driver.active': {AppLang.fr: 'Livraison en cours', AppLang.en: 'Active delivery', AppLang.wo: 'Yónnee ci yoon'},
  'driver.pending': {AppLang.fr: 'Livraisons en attente', AppLang.en: 'Pending deliveries', AppLang.wo: 'Yónnee yu xaar'},
  'driver.pendingEmpty': {AppLang.fr: 'Rien en attente.', AppLang.en: 'Nothing pending.', AppLang.wo: 'Amul.'},
  'driver.accept': {AppLang.fr: 'Accepter', AppLang.en: 'Accept', AppLang.wo: 'Nangu'},
  'driver.accepted': {AppLang.fr: 'Livraison acceptée', AppLang.en: 'Delivery accepted', AppLang.wo: 'Yónnee nangu na'},
  'driver.nextStatus': {AppLang.fr: 'Statut suivant', AppLang.en: 'Next status', AppLang.wo: 'Statut bi ci topp'},
  'driver.orderLine': {AppLang.fr: 'Commande #{id}', AppLang.en: 'Order #{id}', AppLang.wo: 'Commande #{id}'},
  'driver.statusLine': {AppLang.fr: 'Statut : {status}', AppLang.en: 'Status: {status}', AppLang.wo: 'Statut : {status}'},
  'driver.eta': {AppLang.fr: 'ETA {min} min', AppLang.en: 'ETA {min} min', AppLang.wo: 'ETA {min} min'},
  'promos.title': {AppLang.fr: 'Mes promos', AppLang.en: 'My promos', AppLang.wo: 'Sama promo'},
  'promos.add': {AppLang.fr: 'Nouvelle promo', AppLang.en: 'New promo', AppLang.wo: 'Promo bu bees'},
  'promos.edit': {AppLang.fr: 'Modifier la promo', AppLang.en: 'Edit promo', AppLang.wo: 'Soppi promo'},
  'promos.code': {AppLang.fr: 'Code', AppLang.en: 'Code', AppLang.wo: 'Code'},
  'promos.percent': {AppLang.fr: 'Pourcentage', AppLang.en: 'Percent', AppLang.wo: 'Pourcentage'},
  'promos.amount': {AppLang.fr: 'Montant (FCFA)', AppLang.en: 'Amount (FCFA)', AppLang.wo: 'Montant (FCFA)'},
  'promos.minTotal': {AppLang.fr: 'Minimum commande', AppLang.en: 'Min order', AppLang.wo: 'Minimum'},
  'promos.active': {AppLang.fr: 'Active', AppLang.en: 'Active', AppLang.wo: 'Active'},
  'promos.inactive': {AppLang.fr: 'Inactive', AppLang.en: 'Inactive', AppLang.wo: 'Inactive'},
  'promos.empty': {AppLang.fr: 'Aucune promo.', AppLang.en: 'No promos.', AppLang.wo: 'Amul promo.'},
  'promos.emptyHint': {AppLang.fr: 'Crée un code pour tes clients.', AppLang.en: 'Create a code for your customers.', AppLang.wo: 'Sos code ngir sa clients.'},
  'shopSettings.title': {AppLang.fr: 'Paramètres boutique', AppLang.en: 'Shop settings', AppLang.wo: 'Paramètre bitik'},
  'shopSettings.acceptsOrders': {AppLang.fr: 'Accepte les commandes', AppLang.en: 'Accepts orders', AppLang.wo: 'Nangu commande'},
  'shopSettings.acceptsOrdersHint': {AppLang.fr: 'Désactive pour mettre la boutique en pause.', AppLang.en: 'Turn off to pause the shop.', AppLang.wo: 'Feyal ngir taxaw bitik bi.'},
  'shopSettings.minOrder': {AppLang.fr: 'Commande minimum (FCFA)', AppLang.en: 'Min order (FCFA)', AppLang.wo: 'Minimum (FCFA)'},
  'shopSettings.prepTime': {AppLang.fr: 'Temps de préparation (min)', AppLang.en: 'Prep time (min)', AppLang.wo: 'Waxtu préparation (min)'},
  'shopSettings.opensAt': {AppLang.fr: 'Ouverture (HH:MM)', AppLang.en: 'Opens (HH:MM)', AppLang.wo: 'Ubbi (HH:MM)'},
  'shopSettings.closesAt': {AppLang.fr: 'Fermeture (HH:MM)', AppLang.en: 'Closes (HH:MM)', AppLang.wo: 'Tëj (HH:MM)'},
  'shopSettings.saved': {AppLang.fr: 'Paramètres enregistrés', AppLang.en: 'Settings saved', AppLang.wo: 'Paramètre aar na'},
  'groupOrder.title': {AppLang.fr: 'Commande groupée', AppLang.en: 'Group order', AppLang.wo: 'Commande groupe'},
  'groupOrder.createTitle': {AppLang.fr: 'Créer', AppLang.en: 'Create', AppLang.wo: 'Sos'},
  'groupOrder.joinTitle': {AppLang.fr: 'Rejoindre', AppLang.en: 'Join', AppLang.wo: 'Bokk'},
  'groupOrder.sellerId': {AppLang.fr: 'ID vendeur', AppLang.en: 'Seller ID', AppLang.wo: 'ID jaaykat'},
  'groupOrder.create': {AppLang.fr: 'Créer le groupe', AppLang.en: 'Create group', AppLang.wo: 'Sos groupe'},
  'groupOrder.join': {AppLang.fr: 'Rejoindre', AppLang.en: 'Join', AppLang.wo: 'Bokk'},
  'groupOrder.code': {AppLang.fr: 'Code', AppLang.en: 'Code', AppLang.wo: 'Code'},
  'groupOrder.needSeller': {AppLang.fr: 'Indique l’ID vendeur.', AppLang.en: 'Enter a seller ID.', AppLang.wo: 'Dugal ID jaaykat.'},
  'groupOrder.codeLine': {AppLang.fr: 'Code : {code}', AppLang.en: 'Code: {code}', AppLang.wo: 'Code : {code}'},
  'groupOrder.hostLine': {AppLang.fr: 'Hôte : {name}', AppLang.en: 'Host: {name}', AppLang.wo: 'Hôte : {name}'},
  'groupOrder.statusLine': {AppLang.fr: 'Statut : {status}', AppLang.en: 'Status: {status}', AppLang.wo: 'Statut : {status}'},
  'groupOrder.items': {AppLang.fr: 'Articles', AppLang.en: 'Items', AppLang.wo: 'Yëf yi'},
  'groupOrder.noItems': {AppLang.fr: 'Aucun article', AppLang.en: 'No items', AppLang.wo: 'Amul yëf'},
  'groupOrder.noItemsHint': {AppLang.fr: 'Ajoute des plats depuis ton panier.', AppLang.en: 'Add meals from your cart.', AppLang.wo: 'Yokkal ñam ci sa pañe.'},
  'groupOrder.addFromCart': {AppLang.fr: 'Ajouter mon panier', AppLang.en: 'Add my cart', AppLang.wo: 'Yokk sama pañe'},
  'groupOrder.checkout': {AppLang.fr: 'Payer (hôte)', AppLang.en: 'Checkout (host)', AppLang.wo: 'Fey (hôte)'},
  'groupOrder.cartEmpty': {AppLang.fr: 'Panier vide.', AppLang.en: 'Cart is empty.', AppLang.wo: 'Pañe bi amul.'},
  'groupOrder.itemsAdded': {AppLang.fr: 'Articles ajoutés', AppLang.en: 'Items added', AppLang.wo: 'Yëf yokk na'},
  'groupOrder.hostOnly': {AppLang.fr: 'Seul l’hôte peut payer.', AppLang.en: 'Only the host can checkout.', AppLang.wo: 'Hôte rekk mën na fey.'},
  'groupOrder.checkedOut': {AppLang.fr: 'Commande groupée validée', AppLang.en: 'Group order checked out', AppLang.wo: 'Commande groupe dëgg na'},
  'report.title': {AppLang.fr: 'Signaler', AppLang.en: 'Report', AppLang.wo: 'Joxe'},
  'report.post': {AppLang.fr: 'Signaler la publication', AppLang.en: 'Report post', AppLang.wo: 'Joxe yéene bi'},
  'report.user': {AppLang.fr: 'Signaler / bloquer l’utilisateur', AppLang.en: 'Report / block user', AppLang.wo: 'Joxe / téye jëmm'},
  'report.reason': {AppLang.fr: 'Motif', AppLang.en: 'Reason', AppLang.wo: 'Motif'},
  'report.details': {AppLang.fr: 'Détails', AppLang.en: 'Details', AppLang.wo: 'Benn benn'},
  'report.alsoBlock': {AppLang.fr: 'Bloquer aussi cet utilisateur', AppLang.en: 'Also block this user', AppLang.wo: 'Téye itam jëmm bi'},
  'report.submit': {AppLang.fr: 'Envoyer le signalement', AppLang.en: 'Submit report', AppLang.wo: 'Yónnee'},
  'report.sent': {AppLang.fr: 'Signalement envoyé', AppLang.en: 'Report sent', AppLang.wo: 'Joxe yónnee na'},
  'stories.add': {AppLang.fr: 'Ajouter', AppLang.en: 'Add', AppLang.wo: 'Yokk'},
  'home.recent': {AppLang.fr: 'Vus récemment', AppLang.en: 'Recently viewed', AppLang.wo: 'Gis bu mujj'},
  'social.feedDiscover': {AppLang.fr: 'Découverte', AppLang.en: 'Discover', AppLang.wo: 'Gis'},
  'social.feedFollowing': {AppLang.fr: 'Abonnements', AppLang.en: 'Following', AppLang.wo: 'Topp'},
  'orders.filterAll': {AppLang.fr: 'Toutes', AppLang.en: 'All', AppLang.wo: 'Yépp'},
  'orders.cancel': {AppLang.fr: 'Annuler', AppLang.en: 'Cancel order', AppLang.wo: 'Neenal'},
  'orders.cancelTitle': {AppLang.fr: 'Annuler la commande', AppLang.en: 'Cancel order', AppLang.wo: 'Neenal commande'},
  'orders.cancelReason': {AppLang.fr: 'Motif (optionnel)', AppLang.en: 'Reason (optional)', AppLang.wo: 'Motif (optionnel)'},
  'orders.cancelConfirm': {AppLang.fr: 'Confirmer l’annulation', AppLang.en: 'Confirm cancel', AppLang.wo: 'Dëggël neenal'},
  'orders.cancelled': {AppLang.fr: 'Commande annulée', AppLang.en: 'Order cancelled', AppLang.wo: 'Commande neenal na'},
  'orders.reorder': {AppLang.fr: 'Commander à nouveau', AppLang.en: 'Reorder', AppLang.wo: 'Commande waat'},
  'orders.reordered': {AppLang.fr: 'Articles ajoutés au panier', AppLang.en: 'Items added to cart', AppLang.wo: 'Yëf yokk ci pañe'},
  'orders.timeline': {AppLang.fr: 'Suivi', AppLang.en: 'Timeline', AppLang.wo: 'Suivi'},
  'orders.timelineEmpty': {AppLang.fr: 'Aucun événement pour l’instant.', AppLang.en: 'No events yet.', AppLang.wo: 'Amul événement.'},
  'orders.scheduled': {AppLang.fr: 'Planifiée : {when}', AppLang.en: 'Scheduled: {when}', AppLang.wo: 'Planifié : {when}'},
  'orders.cancelReasonLine': {AppLang.fr: 'Motif : {reason}', AppLang.en: 'Reason: {reason}', AppLang.wo: 'Motif : {reason}'},
  'checkout.savedAddresses': {AppLang.fr: 'Adresses enregistrées', AppLang.en: 'Saved addresses', AppLang.wo: 'Adresse yu aar'},
  'checkout.schedule': {AppLang.fr: 'Planifier', AppLang.en: 'Schedule', AppLang.wo: 'Planifier'},
  'checkout.scheduleNow': {AppLang.fr: 'Dès que possible', AppLang.en: 'As soon as possible', AppLang.wo: 'Léegi'},
  'checkout.pointsRedeem': {AppLang.fr: 'Points à utiliser', AppLang.en: 'Points to redeem', AppLang.wo: 'Poñ yu jëfandikoo'},
  'checkout.verifyPoints': {AppLang.fr: 'Vérifier les points', AppLang.en: 'Verify points', AppLang.wo: 'Seet poñ yi'},
  'checkout.pointsDiscount': {AppLang.fr: 'Réduction points : −{amount}', AppLang.en: 'Points discount: −{amount}', AppLang.wo: 'Wàññi poñ : −{amount}'},
  'checkout.multiSellerNote': {
    AppLang.fr: 'Note : plusieurs vendeurs sont autorisés ; un minimum de commande peut s’appliquer par boutique.',
    AppLang.en: 'Note: multiple sellers are allowed; a min order may apply per shop.',
    AppLang.wo: 'Note : ay jaaykat mën nañu ; minimum mën na am ci bitik.',
  },
